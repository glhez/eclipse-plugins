 ...
 * @generated
 */
public class TomcatServerAdapterFactory extends AdapterFactoryImpl {
  /**
   ...
   * @generated
   */
  protected static TomcatServerPackage modelPackage;
   ...
   * @generated
   */
  public TomcatServerAdapterFactory() {
    if (modelPackage == null) {
      modelPackage = TomcatServerPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected TomcatServerSwitch<Adapter> modelSwitch = new TomcatServerSwitch<>() {
    @Override
    public Adapter caseTomcatServerTask(final TomcatServerTask object) {
    ...
    @Override
    public Adapter caseSetupTask(final SetupTask object) {
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.github.glhez.eclipse.plugins.oomph.setup.tomcat.TomcatServerTask
   * <em>Task</em>}'.
   * <!-- begin-user-doc -->
